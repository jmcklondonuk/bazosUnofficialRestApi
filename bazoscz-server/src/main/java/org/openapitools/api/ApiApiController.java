...
import com.jackmckenzie.scraping.bazos.entity.Advertisement;
import com.jackmckenzie.scraping.bazos.entity.Seller;
import com.jackmckenzie.scraping.bazos.service.BazosScraper;
...
public class ApiApiController implements ApiApi {
    ...
    public ResponseEntity<List<org.openapitools.model.Advertisement>> listOwnAdvertisements(
        ...
        List<Advertisement> ads = bazosScraper.listOwnAdvertisements(email, phone, password, downloadPhotos);
    ...
    public ResponseEntity<org.openapitools.model.Advertisement> scrapeOwnAdvertisement(@RequestParam("url") String url,
        ...
        Advertisement ad = bazosScraper.scrapeOwnAdvertisement(url, password, downloadPhotos);
    ...
    public ResponseEntity<Integer> uploadAdvertisement(@RequestBody UploadRequest uploadRequest) throws IOException, InterruptedException {
        Advertisement mappedAd = modelMapper.map(uploadRequest.getAdvertisement(), Advertisement.class);
        Seller mappedSeller = modelMapper.map(uploadRequest.getSeller(), Seller.class);
